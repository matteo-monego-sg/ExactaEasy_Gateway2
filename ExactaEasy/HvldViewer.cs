...
namespace ExactaEasy
{
    ...
    public partial class HvldViewer : UserControl, ICamViewer {
        ...
        public HvldViewer(VisionSystemManager visionSystemMgr, MachineConfiguration machineConfig, int cameraIndex)
            : this() {
        ...
        public void Destroy() {
            ...
            _station.SetParametersCompleted -= _station_SetParametersCompleted;
            _station.ExportedParametersUpdated -= _station_ExportedParametersUpdated;
            // MM-16/01/2024: note the Dispose of the control must be added here for the UI to show correctly!
            SignalStacker.Dispose();
            gviDisplay.Dispose();
            resGrid.Dispose();
        ...
        /// <summary>
        /// MM-16/01/2024: gets a reference to the OptrelSignalStackerControl.
        /// </summary>
        public HvldDisplayControl GetSignalStacker()
        {
            return SignalStacker;
        }
    }
}
